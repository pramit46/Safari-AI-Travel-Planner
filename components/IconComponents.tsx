...
export const PlaneIcon = ({ className = 'w-6 h-6' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className={className}>
        <path d="M12.373 18.995h-.746a.75.75 0 0 1-.75-.75V15.75h-1.5v2.495a.75.75 0 0 1-.75.75h-.746a.75.75 0 0 1-.699-1.033l3.249-6.498-3.25-6.498A.75.75 0 0 1 9.25 4.5h.746a.75.75 0 0 1 .75.75v2.496h1.5V5.25a.75.75 0 0 1 .75-.75h.746a.75.75 0 0 1 .699 1.033l-3.249 6.498 3.249 6.498a.75.75 0 0 1-.699 1.033Z" />
        <path fillRule="evenodd" d="M21.53 12.53a.75.75 0 0 1 0-1.06l-2.25-2.25a.75.75 0 0 1 1.06-1.06l2.25 2.25a2.25 2.25 0 0 1 0 3.18l-2.25 2.25a.75.75 0 1 1-1.06-1.06l2.25-2.25Z" clipRule="evenodd" />
        <path fillRule="evenodd" d="M2.47 12.53a.75.75 0 0 1 0-1.06l2.25-2.25a.75.75 0 0 1 1.06 1.06L3.53 12l2.25 2.25a.75.75 0 0 1-1.06 1.06L2.47 12.53Z" clipRule="evenodd" />
    </svg>
);
